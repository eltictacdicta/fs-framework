...
<head>
    ...
    <meta name="description"
        content="FSFramework es un framework para el desarrollo de aplicaciones web. Es software libre bajo licencia GNU/LGPL." />
        ...
        -->
                                    ...
                                    if ($err == 'permisos') {
                                        ...
                                        <div class="panel panel-danger">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <p class="help-block">
                                                    ...
                                                    bloquea cualquier intento de comprobar si la carpeta tiene permisos de
                                                    escritura.
                                                    Desactiva o modifica la configuración de SELinux para el correcto
                                                    funcionamiento
                                                    de FSFramework.
                                                </p>
                                                <h3>
                                                ...
                                                <p class="help-block">
                                                    Intenta dar permisos de escritura desde el cliente <b>FTP</b> o desde el
                                                    <b>cPanel</b>.
                                                </p>
                                            </div>
                                        </div>
                                            ...
                                            <div class="panel panel-danger">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <p class="help-block">
                                                                Muchos hostings ofrecen <b>varias versiones de PHP</b>. Ve al panel
                                                                de control
                                                        ...
                                                        <li>
                                                            <p class="help-block">
                                                                Busca un proveedor de hosting más completo, que son la mayoría. Mira
                                                                en nuestra sección de
                                                                <a href="<?php echo FS_COMMUNITY_URL; ?>/descargar" rel="nofollow"
                                                                    target="_blank">Hostings recomendados</a>.
                                                            </p>
                                                        </li>
                                                    </ul>
                                                </div>
                                        ...
                                        ?>
                                                <div class="panel panel-danger">
                                                    ...
                                                    <div class="panel-body">
                                                        <p>
                                                            FSFramework necesita la extensión mbstring para poder trabajar con
                                                            caracteres
                                                        ...
                                                        <p class="help-block">
                                                            Algunos proveedores de hosting ofrecen versiones de PHP demasiado
                                                            recortadas.
                                                            Es mejor que busques un proveedor de hosting más completo, que son la
                                                            mayoría.
                                        ...
                                        ?>
                                                    <div class="panel panel-danger">
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            <p class="help-block">
                                                                Ofrecemos una versión de FSFramework para Windows <b>con todo</b> el
                                                                software necesario
                                                                (como OpenSSL) ya incluido de serie. Puedes encontrala en nuestra sección de
                                                                <a href="<?php echo FS_COMMUNITY_URL; ?>/descargar" rel="nofollow"
                                                                    target="_blank">descargas</a>.
                                                                Si decides utilizar <b>un empaquetado distinto</b>, y este no incluye lo
                                                                necesario, deberás
                                                            ...
                                                            <p class="help-block">
                                                                ...
                                                                Nosotros ofrecemos varios empaquetados con todo lo necesario en nuestra
                                                                sección de
                                                                <a href="<?php echo FS_COMMUNITY_URL; ?>/descargar" rel="nofollow"
                                                                    target="_blank">descargas</a>.
                                                            </p>
                                        ...
                                        ?>
                                                        <div class="panel panel-danger">
                                                            ...
                                                            <div class="panel-body">
                                                                ...
                                                                <p class="help-block">Instala el paquete <b>php-zip</b> y reinicia el Apache.
                                                                </p>
                                                                <h3>
                                                                    <i class="fa fa-globe" aria-hidden="true"></i> Hosting
                                                                </h3>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <p class="help-block">
                                    Recuerda que tienes el <b>menú de ayuda</b> arriba a la derecha. Si encuentras
                                    cualquier problema,
                                    haz clic en <b>informar de error...</b> y describe tu duda, sugerencia o el error
                                    que has encontrado.
                                    No sabemos hacer software perfecto, pero con tu ayuda nos podemos acercar cada vez
                                    más ;-)
                                    <br /><br />
                                    Y recuerda que tienes una sección especialmente dedicada a la <b>instalación</b> en
                                    nuestra
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title">
                                                <i class="fa fa-paint-brush"></i> Sistema de Temas -
                                                <?php echo $default_theme; ?>
                                            </h4>
                                        </div>
                                        <div class="modal-body">
                                            <p>
                                                <strong>FSFramework</strong> incluye un sistema de temas basado en plugins
                                                que permite
                                            ...
                                            <p class="help-block">
                                                El tema se activa automáticamente después de la instalación mediante el
                                                sistema de plugins.
                                                Las vistas del tema sobrescriben las vistas básicas del sistema,
                                                proporcionando una
                                                experiencia visual mejorada sin modificar el código del core.
                                            </p>
                                            <p class="help-block">
                                                Puedes cambiar de tema en cualquier momento desde el panel de
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body">
                                                    <p class="help-block">
                                                        Este apartado es totalmente <b>opcional</b>. Si tienes instalado
                                                        memcached,
                                                        puedes especificar aquí la ruta, puerto y prefijo a utilizar. Si
                                                        no,
                                                        déjalo como está.
                                                    </p>
                                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <p>
                                                    <a href="https://github.com/PHPMailer/PHPMailer/">phpmailer</a> con
                                                    la misma licencia
                                                    <a href="extras/phpmailer/LICENSE">LGPL</a>.
                                                    <br />
                                                    Para la parte gráfica se incluye el framewrowk <a
                                                        href="http://getbootstrap.com">Bootstrap</a>, con licencia
                                                    <a
                                                        href="https://github.com/twbs/bootstrap/blob/master/LICENSE">MIT</a>
                                                    y
                                                    <a href="http://fontawesome.io">font-awesome</a> también con
                                                    licencia <a href="http://fontawesome.io/license">MIT</a>.
                                                    <br />
                                                    Y por último, pero no menos importante, también incluye <a
                                                        href="https://github.com/jquery/jquery">jQuery</a>,
                                                    con licencia <a
                                                        href="https://github.com/jquery/jquery/blob/master/LICENSE.txt">MIT</a>.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row" style="margin-bottom: 20px;">
                            <div class="col-sm-12 text-center">
                                ...
                                <small>
                                    ...
                                    <a target="_blank" href="<?php echo FS_COMMUNITY_URL; ?>"
