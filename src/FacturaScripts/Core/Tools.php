...
/**
 * Bridge for FacturaScripts Tools class.
 * Provides utility methods for file operations, configuration, and logging.
 */
class Tools
{
    /**
    ...
    public static function log()
    {
        return new class {
            public function error($msg, $params = [])
            {
                ...
                // Also add to FSFramework core log for display
