    ...
    public function saveGeneratesLogKeyWhenNull(): void
    {
        $user = new class() extends \fs_user {
            public function __construct()
            {
                ...
                $this->log_key = null;  // NULL log_key — save() must generate one
                $this->codagente = null;
                $this->admin = false;
                $this->enabled = true;
        ...
        $this->assertNull($user->log_key, 'log_key should start as null');
        ...
        $this->assertNotNull($user->log_key, 'log_key MUST be generated by save() when null');
