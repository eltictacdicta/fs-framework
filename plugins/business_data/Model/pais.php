...
class Pais extends \fs_model
{
     ...
     * @param string $cod
     * @return boolean|\FSFramework\Plugin\BusinessData\Model\Pais
     */
     ...
     * @param string $cod
     * @return \FSFramework\Plugin\BusinessData\Model\Pais|boolean
     */
     ...
     * @return \FSFramework\Plugin\BusinessData\Model\Pais
     */
    public function all()
    {
