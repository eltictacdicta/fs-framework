...
description: >-
  Sube la versión del core FSFramework, crea tag vX.Y.Z y
...
3. **No commitear plugins ignorados**: los plugins bajo `plugins/` con repo propio tienen release independiente.
